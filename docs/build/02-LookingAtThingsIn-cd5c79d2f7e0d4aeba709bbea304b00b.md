...
- A function to get what are the stands that are the neighbours of a stand if we want to propagate a cut accross several stand; a function to propagate the cuts from stand to stand until we reach a certain size; etc., etc.
