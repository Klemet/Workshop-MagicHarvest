...
repeatPrescriptionPath = "./input/disturbances/harvesting/temp/repeatedPrescriptions.json"
if os.path.exists("repeatPrescriptionPath"):
    with open(repeatPrescriptionPath) as json_file:
        repeatPrescriptionsDict = json.load(json_file)
else:
